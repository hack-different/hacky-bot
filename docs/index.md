...
You can use the [editor on GitHub](https://github.com/hack-different/hacky-bot/edit/main/docs/index.md) to maintain and
...
your [repository settings](https://github.com/hack-different/hacky-bot/settings/pages). The name of this theme is saved
